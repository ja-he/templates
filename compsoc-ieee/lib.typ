...
#let ieee(
  ...
  place(
    ...
    clearance: 30pt,
    {
      ...
      show std.title: set text(size: 13.9pt, weight: "bold")
      show std.title: set block(below: 0.6in)
      std.title()
  ...
  set par(justify: true, first-line-indent: (amount: fli-len, all: true), spacing: 0.5em, leading: 0.467em)
